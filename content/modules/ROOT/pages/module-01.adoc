...
Staleness and deletion is a new feature just released in April 2024. 
...
As mentioned earlier this typically takes 10-15 minutes with the selections identified in the lab exercise, but the additional load on the system may cause this to take a little longer.
